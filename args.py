...
def get_args(description='MILNCE'):
    ...
    parser.add_argument('--train_csv', type=str, default='../../../data/project/rw/HowTo100M/csv/small_videos.csv', help='train csv')
    parser.add_argument('--video_path', type=str, default='../../../data/project/rw/HowTo100M/videos', help='video_path')
    parser.add_argument('--caption_root', type=str, default='../../../data/project/rw/HowTo100M/caption_json', help='video_path')
    ...
    parser.add_argument('--eval_video_root', type=str, default='../../../data/project/rw/HowTo100M/downstream/hmdb', help='root folder for the video at for evaluation')
    ...
    parser.add_argument('--num_frames', type=int, default=16, help='random seed')
    ...
    parser.add_argument('--word2vec_path', type=str, default='../../../data/project/rw/HowTo100M/data/word2vec.pth', help='')
    parser.add_argument('--fps', type=int, default=5, help='')
    parser.add_argument('--cudnn_benchmark', type=int, default=0, help='')
    parser.add_argument('--epochs', default=150000, type=int, metavar='N', help='number of total epochs to run')
    ...
    parser.add_argument('--dist-url', default='tcp://9.0.226.130:23456', type=str, help='url used to set up distributed training')
