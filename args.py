...
def get_args(description='MILNCE'):
    ...
    parser.add_argument('--train_csv', type=str, default='../HowTo100M/csv/new_videos.csv', help='train csv')
    parser.add_argument('--video_path', type=str, default='../HowTo100M/videos', help='video_path')
    parser.add_argument('--caption_root', type=str, default='../HowTo100M/caption_json', help='video_path')
    ...
    parser.add_argument('--eval_video_root', type=str, default='../HowTo100M/downstream/hmdb', help='root folder for the video at for evaluation')
    ...
    parser.add_argument('--word2vec_path', type=str, default='../HowTo100M/data/word2vec.pth', help='')
    ...
    parser.add_argument('--dist-url', default='tcp://9.0.220.130:23456', type=str, help='url used to set up distributed training')
