...
def get_args(description='MILNCE'):
    ...
    parser.add_argument('--train_csv', type=str, default='../HowTo100M/csv/small_videos.csv', help='train csv')
    ...
    parser.add_argument('--eval_video_root', type=str, default='../HowTo100M/downstream', help='root folder for the video at for evaluation')
    ...
    parser.add_argument('--warmup_steps', type=int, default=1000, help='')
    ...
    parser.add_argument('--dist-url', default='tcp://9.0.205.130:23456', type=str, help='url used to set up distributed training')
